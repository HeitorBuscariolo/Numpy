...
print("This errored out because numpy can only multiplies arrays if their shapes are compatible")
...
## this worked! why?
print("Numpy performs element-by-element multiplication when the arrays have matching dimensions")
